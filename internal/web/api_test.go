...
const (
	...
	zeroDetailJSON = `{"summary":` + zeroSummaryJSON + `,"providerRef":"","size":null,"requirements":null,` +
		`"selection":null,"durationSeconds":0,"teardownGraceSeconds":null,"workloadNamespaces":[],"workloadSelector":null,` +
		`"workloadMode":null,"workloadBurstReplicas":null,"migratedWorkloads":[],` +
		`"migrationWarnings":[],` +
