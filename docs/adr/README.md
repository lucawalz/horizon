...
- [0006. Become a thin Cluster-API operator instead of a provisioning controller](0006-cluster-api-operator-pivot.md) (superseded by 0018)
- [0007. Add on-demand capacity through MachineDeployments in two modes](0007-on-demand-pools-via-machinedeployments.md) (superseded by 0017)
- [0008. Retire the laptop watch daemon and WireGuard](0008-retire-watch-daemon-and-wireguard.md) (superseded by 0017)
...
- [0013. What the Cluster API move bought over Terraform](0013-cluster-api-over-terraform.md) (superseded by 0017)
