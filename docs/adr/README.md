...
- [0011. Add a first-run setup wizard](0011-first-run-setup-wizard.md) (accepted)
...
- [0016. Make horizon a cluster-agnostic tool with a provider seam](0016-cluster-agnostic-tool-with-provider-seam.md) (accepted)
